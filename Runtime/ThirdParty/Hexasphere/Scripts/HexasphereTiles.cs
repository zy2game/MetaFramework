...
namespace HexasphereGrid {
	...
	public partial class Hexasphere: MonoBehaviour {
        ...
        [Obsolete("Use GetTileAtPosition")]
		public int GetTileAtPos (Vector3 worldPosition) {
			return GetTileAtPosition(worldPosition, worldSpace: true);
		}
		...
		[Obsolete("Use GetTileAtPosition and pass worldSpace parameter = false")]
