...
public static class MyXLuaConfig
{
    ...
    static List<string> exclude = new List<string> {
        ...
        "AnimatorControllerParameter",
         ...
         "Input",
         "RuntimeTypeModel",
         "ClusterSerialization","UnityEngine.ClusterSerialization",
         "SmoothJointEditer", "SmoothJointEditer_j",
         "SmoothJointColliderObj", "SmoothJoint", "SmoothJoint_j",
          "SmoothJointColliderObj_j",
         "LightingSettings",
        ...
        get
        {
            ...
            var unityTypes = (from assembly in AppDomain.CurrentDomain.GetAssemblies()
                              ...
                              where type.Namespace != null && namespaces.Contains(type.Namespace) && !isExcluded(type)
                                      && type.BaseType != typeof(MulticastDelegate) && !type.IsInterface && !type.IsEnum && !type.Name.StartsWith("AudioSource")
                              select type);
            ...
            var result = from t in customTypes where !t.Name.StartsWith("Smooth") && !t.Name.StartsWith("UIInput")  select t;

          //  D.Log(result.Count());

            foreach (var t in result)
            {
                //D.Log(t.Namespace + "    " + t.FullName + "     " + t.Name,"#ffff00");
            }
            return unityTypes.Concat(result);
        }
    }
    ...
    //                UnityEngine.Debug.Log(p+" ==>> "+p.BaseType);
    ...
    public static Func<MemberInfo, bool> MethodFilter = (memberInfo) =>
    {
        ...
        //    {
        //        var methodInfo = memberInfo as MethodInfo;
        //        if (memberInfo_exclude.Contains(methodInfo.Name))
        //        {
        //            return true;
        //        }
        //    }
        ...
        //        if (memberInfo_exclude.Contains(propertyInfo.Name))
        //        {
        //            return true;
        //        }
    ...
    //---------------------------------Add for Unity2019
    private static List<string> memberInfo_exclude = new List<string>() {
        "IsJoystickPreconfigured","OnRequestRebuild",
        "SetNoBackupFlag","ResetNoBackupFlag",
        "GetSpatializerPluginNames","StopRecordingUndo",
        "StartRecordingUndo", "AnimatorControllerParameter.name",
        "scaleInLightmap","receiveGI",
        "stitchLightmapSeams","FindAll",
        "SetSpatializerPluginName","dering",
        "OnRequestRebuild","supportsMeshInstancing",
        "imageContentsHash","OnRebuildRequested"
